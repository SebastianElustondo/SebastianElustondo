...
<sub>This repo is also the source of sebastian.quovra.com; see <a href="DOCS.md">DOCS.md</a>. The banner, cards and stack above are generated by the stdlib-only scripts in <code>scripts/</code>.</sub>
